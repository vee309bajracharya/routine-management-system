...
const SemesterList = () => {
  ...
  return (
    <div className="academic-common-bg">
      {/* Header Section */}
      <div className="mb-8">
        <h1 className="form-header text-2xl font-bold">Semesters</h1>
      ...
      {isLoading ? (
        <div className="flex flex-col items-center justify-center min-h-[400px]">
          ...
          <p className="text-sub-text text-sm">Loading semesters...</p>
        </div>
      ) : semesters.length === 0 ? (
        <div className="flex flex-col items-center justify-center min-h-[400px] bg-gray-50 dark:bg-dark-hover rounded-lg">
          <p className="text-sub-text text-base">No semesters found</p>
        </div>
      ) : (
        <>
        ...
        {isEditModalOpen && selectedSem && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center px-4">
            ...
            >
              ...
              <h2 className="form-header">Edit Semester Details</h2>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  disabled
                  className="dropdown-select cursor-not-allowed bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400"
                />
