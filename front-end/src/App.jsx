...
const ForgotPassword = lazy(() => import("./pages/features/auth/ForgotPassword"));
const ResetPassword = lazy(() => import("./pages/features/auth/ResetPassword"));
...
//Admin Sidebar -> Academic Structure sidebar
...
const TeacherAvaibility = lazy(() => import("./pages/users/admin/academic-structure/TeacherAvaibility"));

//Admin Sidebar -> Academic Details section
const DepartmentList = lazy(() => import("./pages/users/admin/academic-details/DepartmentList"));
const AcademicYearsList = lazy(() => import("./pages/users/admin/academic-details/AcademicYearsList"));
const SemesterList = lazy(() => import("./pages/users/admin/academic-details/SemesterList"));
const BatchList = lazy(() => import("./pages/users/admin/academic-details/BatchList"));
const CourseList = lazy(() => import("./pages/users/admin/academic-details/CourseList"));
const TimeSlotList = lazy(() => import("./pages/users/admin/academic-details/TimeSlotList"));
const CourseAssignmentList = lazy(() => import("./pages/users/admin/academic-details/CourseAssignmentList"));
const TeacherAvailabilityList = lazy(() => import("./pages/users/admin/academic-details/TeacherAvailabilityList"));

//Teacher Pages
const TeacherDashboard = lazy(() => import("./pages/users/teacher/TeacherDashboard"));
const TeacherSchedule = lazy(() => import("./pages/users/teacher/TeacherSchedule"));
const TeacherSetting = lazy(() => import("./pages/users/teacher/TeacherSetting"));
const TeacherRoutine = lazy(() => import("./pages/users/teacher/TeacherRoutine"));
      ...
      <Routes>
        ...
        >
          ...
          <Route path="academic-details">
            {/* default route to the Department List */}
            ...
            <Route path="course-assignment" element={<CourseAssignmentList />} />
            <Route path="teacher-availability" element={<TeacherAvailabilityList />} />
          </Route>
